  ...
  return (
    <main className={darkMode ? 'main dark' : 'main'}>
      <section className="main_container">
        <div className="main_item" data-aos="zoom-in" data-aos-duration="1000">
        ...
        >
          <h2 className="big_text text">Geonho Kim</h2>
        </div>
        <div className="main_item" data-aos="zoom-out" data-aos-duration="1000">
          <Typewriter
            className="text"
            options={{
              strings: [
