            ...
            <div className="items">
              {isLoaderInfo ? (
                ...
                >
                  ...
                  <p>
                    열심히 하는 개발자를 넘어 잘하는 개발자가 되기 위해서
                    노력하겠습니다.
                  </p>
                </div>
              ) : (
                ...
                <ul className="skills">
                  <li data-aos="zoom-in-right" data-aos-duration="1000">
                    ...
                    <div>
                      ...
                      <p>
                        JS를 이용하여 DOM객체 조작과, 이벤트 처리가 가능합니다.
                      </p>
                  ...
                  <li data-aos="zoom-in-right" data-aos-duration="1000">
                    ...
                    <div>
                      <p>
                        웹 접근성을 고려한 시멘틱한 마크업을 작성할 수 있습니다.
                      </p>
                      <p>미디어 쿼리를 통한 반응형 웹 개발을 할 수 있습니다.</p>
                      <p>
                        Bootstrap을 사용하여 웹 페이지를 구현한 경험이 있습니다.
                      </p>
                    </div>
                  </li>
                  <li data-aos="zoom-in-left" data-aos-duration="1000">
                  ...
                  <li data-aos="zoom-in-right" data-aos-duration="1000">
                    ...
                    <div>
                      ...
                      <p>
                        Mongoose 라이브러리를 사용하여 React, Node와 연동한
                        경험이 있습니다.
                      </p>
                      <p></p>
                    </div>
                  ...
                  <li data-aos="zoom-in-left" data-aos-duration="1000">
                    ...
                    <div>
                      <p>
                        Firebase 의 Authentication를 이용한 계정관리 프로젝트
                        경험이 있습니다.
                      </p>
                      <p>
                        FireStore 의 DB기능을 통한 채팅앱 프로젝트 경험이
                        있습니다.
                      </p>
                      <p></p>
                    </div>
